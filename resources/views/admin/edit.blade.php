                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form :action=" route('admin.store')" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input autofocus="true" type="text" id="title" name="title" value="{{ $topic->title }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input autofocus="true" type="text" id="question" name="question" value="{{ $questions->question??"" }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input autofocus="true" type="text" id="answer" name="answer" value="{{ $questions->answer??"" }}"
